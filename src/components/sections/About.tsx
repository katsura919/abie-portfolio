            ...
            <div className="max-w-[2200px] mx-auto w-full px-8 md:px-16 lg:px-24 xl:px-32">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                    ...
                    <div className="lg:col-span-7 xl:col-span-7 flex flex-col justify-center">
                        <h2 className="font-sans text-5xl sm:text-6xl md:text-7xl xl:text-[5rem] font-bold uppercase tracking-tighter text-foreground leading-[0.95] max-w-4xl text-balance">
                            I'm a Digital Nomad Creator & Systems Engineer
                        </h2>
                        <p className="font-serif mt-6 text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">

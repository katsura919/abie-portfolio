            ...
            <div className="relative flex flex-col md:flex-row min-h-[100dvh] max-w-[2200px] mx-auto w-full pt-16 md:pt-0">
                ...
                <div className="relative z-10 w-full md:w-1/2 flex flex-col justify-center md:justify-between px-8 py-6 md:px-16 md:py-16 lg:px-24 xl:px-32 pointer-events-none order-2 md:order-none min-h-[60vh] md:min-h-0">
                    ...
                    <div className="pointer-events-auto flex flex-col justify-center mt-4 md:mt-0">
                        <p className="text-lg md:text-xl mb-2 text-foreground font-serif opacity-90">Hey. I'm Abie,</p>
                        <h1 className="font-sans text-6xl sm:text-7xl md:text-6xl lg:text-7xl xl:text-[85px] leading-[0.9] font-bold uppercase tracking-tighter text-foreground">
                            The<br />Nomad<br />
                        ...
                        <p className="font-serif mt-5 text-base sm:text-lg md:text-base lg:text-lg xl:text-xl leading-relaxed max-w-[95%] sm:max-w-md text-muted-foreground font-medium">

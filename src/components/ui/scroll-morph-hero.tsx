            ...
            >
                ...
                >
                    <div className="text-center flex flex-col items-center justify-center gap-1">
                        ...
                        <p className="text-[10px] font-medium text-white leading-none">Details</p>
                    </div>
                </div>
            </motion.div>
        </motion.div>
...
export default function IntroAnimation() {
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full bg-background overflow-hidden border-t">
            {/* Container */}
